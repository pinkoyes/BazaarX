...
// const Header = () => {
//   return (
//     <header className="w-full static top-0 left-0 right-0 flex items-center h-16 px-2 md:px-24 justify-between bg-white dark:bg-black md:h-20 shadow-md">
//       {/* left side */}
...
//           alt="OpenMarket Logo"
//           className="object-cover h-16 w-16 hover:scale-110 transition-all duration-300"
//         />
//         {/* Title */}
//         <Link
//           to="/"
...
//         <Menu className="w-8 h-8 text-gray-700 dark:text-gray-200 cursor-pointer" />
//       </div>
//     </header>
//   );
// };
